...
def nn(s,h,l,v):
    ...
    for i in range(0,5):
        m1=cntk.layers.Recurrence(cntk.layers.LSTM(100,activation=cntk.tanh,init_bias=0.1,enable_self_stabilization=True))(m)
    m=cntk.splice(m,l)
    m=cntk.layers.Stabilizer()(m)
    for i in range(0,5):
        m2=cntk.layers.Recurrence(cntk.layers.LSTM(100,activation=cntk.tanh,init_bias=0.1,enable_self_stabilization=True))(m)
    m=cntk.splice(m,v)
    m=cntk.layers.Stabilizer()(m)
    for i in range(0,5):
        m=cntk.layers.Recurrence(cntk.layers.LSTM(100,activation=cntk.tanh,init_bias=0.1,enable_self_stabilization=True))(m)

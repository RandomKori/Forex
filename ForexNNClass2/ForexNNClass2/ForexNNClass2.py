...
def LoadData(fn,is_training):
    n=".\\Data\\"+fn
    datainps=cntk.io.StreamDef("spread",20)
    datainph=cntk.io.StreamDef("high",20)
    datainpl=cntk.io.StreamDef("low",20)
    datainpv=cntk.io.StreamDef("volume",20)
...
input_s = cntk.input_variable(20,np.float32, name = 'spread',dynamic_axes=cntk.axis.Axis.default_input_variable_dynamic_axes())
input_h = cntk.input_variable(20,np.float32, name = 'high',dynamic_axes=cntk.axis.Axis.default_input_variable_dynamic_axes())
input_l = cntk.input_variable(20,np.float32, name = 'low',dynamic_axes=cntk.axis.Axis.default_input_variable_dynamic_axes())
input_v = cntk.input_variable(20,np.float32, name = 'volume',dynamic_axes=cntk.axis.Axis.default_input_variable_dynamic_axes())
